...
function AccordionAndImg() {
  return (
    <div className="w-full h-fit bg-[#F5F5F5] relative">
      {/* bg */}
      ...
      <div className="2xl:container 2xl:mx-auto flex flex-col gap-y-10 items-center   relative pb-20 mt-20 md:mt-36 px-5 lg:flex-row lg:justify-between">
        {/* ------------------ image -------------------------- */}
        <div className="relative z-20 bg-primary p-5 h-screen overflow-hidden w-full  mt-20 lg:w-[47%]">
          {/* decorative shapes */}
